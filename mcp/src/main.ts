...
Tools:   imtakt_find, imtakt_plan, imtakt_show, imtakt_status, imtakt_follow
         (aliases: imtakt_find_station, imtakt_plan_journey, imtakt_journey_show,
          imtakt_station_live, imtakt_view_train, imtakt_view_station)
